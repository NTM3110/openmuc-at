...
//         Assertions.assertThrows(ConnectionException.class, () -> driverCon.read(records, null, null));
//         Flag actualFlag = records.get(0).getRecord().getFlag();
//         assertEquals(Flag.DRIVER_ERROR_UNSPECIFIED, actualFlag);
//     }
...
//         assertEquals(Flag.DRIVER_ERROR_UNSPECIFIED, records.get(0).getRecord().getFlag());
//     }
